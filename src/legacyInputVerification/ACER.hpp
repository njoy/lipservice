...
public:
  /* nested types */
  #include "legacyInputVerification/ACER/Card1.hpp"
  #include "legacyInputVerification/ACER/Card2.hpp"
  #include "legacyInputVerification/ACER/Card3.hpp"
  #include "legacyInputVerification/ACER/Card4.hpp"
  #include "legacyInputVerification/ACER/Card5.hpp"
  #include "legacyInputVerification/ACER/Card6.hpp"
  #include "legacyInputVerification/ACER/Card7.hpp"
  #include "legacyInputVerification/ACER/Card8.hpp"
  #include "legacyInputVerification/ACER/Card8a.hpp"
  #include "legacyInputVerification/ACER/Card9.hpp"
  #include "legacyInputVerification/ACER/Card10.hpp"
  #include "legacyInputVerification/ACER/Card11.hpp"
