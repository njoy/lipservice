...
public:
  ...
  #include "legacyInputVerification/PURR/Card2/Ntemp.hpp"
  #include "legacyInputVerification/PURR/Card2/Nsigz.hpp"
  #include "legacyInputVerification/PURR/Card2/Nbin.hpp"
  #include "legacyInputVerification/PURR/Card2/Nladr.hpp"
  #include "legacyInputVerification/PURR/Card2/Iprint.hpp"
  #include "legacyInputVerification/PURR/Card2/Nunx.hpp"
