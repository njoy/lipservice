class Card1 {
public:
  #include "legacyInputVerification/GROUPR/Card1/Nendf.hpp"
  #include "legacyInputVerification/GROUPR/Card1/Npend.hpp"
  #include "legacyInputVerification/GROUPR/Card1/Ngout1.hpp"
  #include "legacyInputVerification/GROUPR/Card1/Ngout2.hpp"
