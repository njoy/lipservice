class Card9 {
public:
  #include "legacyInputVerification/GROUPR/Card9/Mfd.hpp"
  #include "legacyInputVerification/GROUPR/Card9/Mtd.hpp"
  #include "legacyInputVerification/GROUPR/Card9/Mtname.hpp"
