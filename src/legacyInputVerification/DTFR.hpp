class DTFR {
public:
  #include "legacyInputVerification/DTFR/Card1.hpp"
  #include "legacyInputVerification/DTFR/Card2.hpp"
  #include "legacyInputVerification/DTFR/Card3.hpp"
  #include "legacyInputVerification/DTFR/Card3a.hpp"
  #include "legacyInputVerification/DTFR/Card4.hpp"
  #include "legacyInputVerification/DTFR/Card5.hpp"
  #include "legacyInputVerification/DTFR/Card6.hpp"
  #include "legacyInputVerification/DTFR/Card7.hpp"
  #include "legacyInputVerification/DTFR/Card8.hpp"
