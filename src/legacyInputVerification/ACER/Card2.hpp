class Card2 {
public:
  #include "legacyInputVerification/ACER/Card2/Iopt.hpp"
  #include "legacyInputVerification/ACER/Card2/Iprint.hpp"
  #include "legacyInputVerification/ACER/Card2/Itype.hpp"
  #include "legacyInputVerification/ACER/Card2/Suff.hpp"
  #include "legacyInputVerification/ACER/Card2/Nxtra.hpp"
