class Card1 {
public:
  #include "legacyInputVerification/ACER/Card1/Nendf.hpp"
  #include "legacyInputVerification/ACER/Card1/Npend.hpp"
  #include "legacyInputVerification/ACER/Card1/Ngend.hpp"
  #include "legacyInputVerification/ACER/Card1/Nace.hpp"
  #include "legacyInputVerification/ACER/Card1/Ndir.hpp"
