...
public:
  ...
  #include "legacyInputVerification/ACER/Card6/Newfor.hpp"
  #include "legacyInputVerification/ACER/Card6/Iopp.hpp"
  #include "legacyInputVerification/ACER/Card6/Ismooth.hpp"
