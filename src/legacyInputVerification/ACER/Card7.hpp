class Card7 {
public:
  #include "legacyInputVerification/ACER/Card7/Thin1.hpp"
  #include "legacyInputVerification/ACER/Card7/Thin2.hpp"
  #include "legacyInputVerification/ACER/Card7/Thin3.hpp"
