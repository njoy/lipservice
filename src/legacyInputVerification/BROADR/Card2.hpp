class Card2 {
public:
  #include "legacyInputVerification/BROADR/Card2/Mat1.hpp"
  #include "legacyInputVerification/BROADR/Card2/Ntemp2.hpp"
  #include "legacyInputVerification/BROADR/Card2/Istart.hpp"
  #include "legacyInputVerification/BROADR/Card2/Istrap.hpp"
  #include "legacyInputVerification/BROADR/Card2/Temp1.hpp"
