class Card3 {
public:
  #include "legacyInputVerification/BROADR/Card3/Errthn.hpp"
  #include "legacyInputVerification/BROADR/Card3/Thnmax.hpp"
  #include "legacyInputVerification/BROADR/Card3/Errmax.hpp"
  #include "legacyInputVerification/BROADR/Card3/Errint.hpp"
