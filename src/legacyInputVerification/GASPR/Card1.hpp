class Card1 {
public:
  #include "legacyInputVerification/GASPR/Card1/Nendf.hpp"
  #include "legacyInputVerification/GASPR/Card1/Nin.hpp"
  #include "legacyInputVerification/GASPR/Card1/Nout.hpp"
