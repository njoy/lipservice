...
public:
  ...
  #include "legacyInputVerification/MATXSR/Card1/Ngen1.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Ngen2.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Nmatx.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Ngen3.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Ngen4.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Ngen5.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Ngen6.hpp"
  #include "legacyInputVerification/MATXSR/Card1/Ngen7.hpp"
