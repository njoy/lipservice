...
public:
  ...
  #include "legacyInputVerification/MATXSR/Card10/Hmat.hpp"
  #include "legacyInputVerification/MATXSR/Card10/Matno.hpp"
  #include "legacyInputVerification/MATXSR/Card10/Matgg.hpp"
