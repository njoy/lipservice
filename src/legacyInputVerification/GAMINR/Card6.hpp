class Card6 {
public:
  #include "legacyInputVerification/GAMINR/Card6/Mfd.hpp"
  using Mtd = GROUPR::Card9::Mtd;
  #include "legacyInputVerification/GAMINR/Card6/Mtname.hpp"

  #include "legacyInputVerification/GAMINR/Card6/src/readRest.hpp"
