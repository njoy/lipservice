class Card13 {
  public:
  #include "legacyInputVerification/LEAPR/Card13/Twt.hpp"
  #include "legacyInputVerification/LEAPR/Card13/C.hpp"
  #include "legacyInputVerification/LEAPR/Card13/Tbeta.hpp"
