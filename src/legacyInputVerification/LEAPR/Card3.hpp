class Card3 {
public:
  #include "legacyInputVerification/LEAPR/Card3/Ntempr.hpp"
  #include "legacyInputVerification/LEAPR/Card3/Iprint.hpp"
  #include "legacyInputVerification/LEAPR/Card3/Nphon.hpp"
