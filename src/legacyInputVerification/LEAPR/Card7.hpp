class Card7 {
  public:
  #include "legacyInputVerification/LEAPR/Card7/Nalpha.hpp"
  #include "legacyInputVerification/LEAPR/Card7/Nbeta.hpp"
  #include "legacyInputVerification/LEAPR/Card7/Lat.hpp"
