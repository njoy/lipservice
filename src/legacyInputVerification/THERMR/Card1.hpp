class Card1 {
public:
  #include "legacyInputVerification/THERMR/Card1/Nendf.hpp"
  #include "legacyInputVerification/THERMR/Card1/Nin.hpp"
  #include "legacyInputVerification/THERMR/Card1/Nout.hpp"
