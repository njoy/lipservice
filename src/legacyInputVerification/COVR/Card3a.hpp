class Card3a {
  public:
    #include "legacyInputVerification/COVR/Card3a/Irelco.hpp"
    #include "legacyInputVerification/COVR/Card3a/Ncase.hpp"
    #include "legacyInputVerification/COVR/Card3a/Noleg.hpp"
    #include "legacyInputVerification/COVR/Card3a/Nstart.hpp"
    #include "legacyInputVerification/COVR/Card3a/Ndiv.hpp"
