...
public:
  /* nested types */
  #include "legacyInputVerification/PURR/Card1.hpp"
  #include "legacyInputVerification/PURR/Card2.hpp"
  #include "legacyInputVerification/PURR/Card3.hpp"
  #include "legacyInputVerification/PURR/Card4.hpp"
