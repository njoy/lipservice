...
public:
  ...
  #include "legacyInputVerification/WIMSR/Card2/Iprint.hpp"
  #include "legacyInputVerification/WIMSR/Card2/Iverw.hpp"
  #include "legacyInputVerification/WIMSR/Card2/Igroup.hpp"
