...
public:
  ...
  #include "legacyInputVerification/WIMSR/Card4/Ntemp.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Nsigz.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Sgref.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Ires.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Sigp.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Mti.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Mtc.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Ip1opt.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Inorf.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Isof.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Ifprod.hpp"
  #include "legacyInputVerification/WIMSR/Card4/Jp1.hpp"
