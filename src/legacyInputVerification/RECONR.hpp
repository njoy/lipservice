...
public:
  /* nested types */
  #include "legacyInputVerification/RECONR/Card1.hpp"
  #include "legacyInputVerification/RECONR/Card2.hpp"
  #include "legacyInputVerification/RECONR/Card3.hpp"
  #include "legacyInputVerification/RECONR/Card4.hpp"
  #include "legacyInputVerification/RECONR/Card5.hpp"
  #include "legacyInputVerification/RECONR/Card6.hpp"
