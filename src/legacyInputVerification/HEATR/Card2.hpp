class Card2 {
  ...
  #include "legacyInputVerification/HEATR/Card2/Npk.hpp"
  #include "legacyInputVerification/HEATR/Card2/Nqa.hpp"
  #include "legacyInputVerification/HEATR/Card2/Ntemp.hpp"
  #include "legacyInputVerification/HEATR/Card2/Local.hpp"
  #include "legacyInputVerification/HEATR/Card2/Iprint.hpp"
  #include "legacyInputVerification/HEATR/Card2/Ed.hpp"
