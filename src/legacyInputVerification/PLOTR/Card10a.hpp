class Card10a {
public:
  #include "legacyInputVerification/PLOTR/Card10a/Xtag.hpp"
  #include "legacyInputVerification/PLOTR/Card10a/Ytag.hpp"
  #include "legacyInputVerification/PLOTR/Card10a/Xpoint.hpp"
