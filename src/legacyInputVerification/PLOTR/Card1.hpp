class Card1 {
public:
  #include "legacyInputVerification/PLOTR/Card1/Lori.hpp"
  #include "legacyInputVerification/PLOTR/Card1/Istyle.hpp"
  #include "legacyInputVerification/PLOTR/Card1/Size.hpp"
  #include "legacyInputVerification/PLOTR/Card1/Ipcol.hpp"
