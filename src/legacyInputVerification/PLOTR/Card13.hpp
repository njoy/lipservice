class Card13 {
public:
  #include "legacyInputVerification/PLOTR/Card13/Xdata.hpp"
  #include "legacyInputVerification/PLOTR/Card13/Ydata.hpp"
  #include "legacyInputVerification/PLOTR/Card13/Yerr1.hpp"
  #include "legacyInputVerification/PLOTR/Card13/Yerr2.hpp"
  #include "legacyInputVerification/PLOTR/Card13/Xerr1.hpp"
  #include "legacyInputVerification/PLOTR/Card13/Xerr2.hpp"
