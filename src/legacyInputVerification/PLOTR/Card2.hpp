class Card2 {
public:
  #include "legacyInputVerification/PLOTR/Card2/Iplot.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Iwcol.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Factx.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Facty.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Ll.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Ww.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Wh.hpp"
  #include "legacyInputVerification/PLOTR/Card2/Wr.hpp"
