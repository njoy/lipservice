class Card4 {
public:
  #include "legacyInputVerification/RECONR/Card4/Err.hpp"
  #include "legacyInputVerification/RECONR/Card4/Tempr.hpp"
  #include "legacyInputVerification/RECONR/Card4/Errmax.hpp"
  #include "legacyInputVerification/RECONR/Card4/Errint.hpp"
