class Card2 {
  public:
  #include "legacyInputVerification/DTFR/Card2/Iprint.hpp"
  #include "legacyInputVerification/DTFR/Card2/Ifilm.hpp"
  #include "legacyInputVerification/DTFR/Card2/Iedit.hpp"
