class DTFR {
public:
  #include "lipservice/DTFR/Card1.hpp"
  #include "lipservice/DTFR/Card2.hpp"
  #include "lipservice/DTFR/Card3.hpp"
  #include "lipservice/DTFR/Card3a.hpp"
  #include "lipservice/DTFR/Card4.hpp"
  #include "lipservice/DTFR/Card5.hpp"
  #include "lipservice/DTFR/Card6.hpp"
  #include "lipservice/DTFR/Card7.hpp"
  #include "lipservice/DTFR/Card8.hpp"
