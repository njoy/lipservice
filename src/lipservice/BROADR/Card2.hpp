class Card2 {
public:
  #include "lipservice/BROADR/Card2/Mat1.hpp"
  #include "lipservice/BROADR/Card2/Ntemp2.hpp"
  #include "lipservice/BROADR/Card2/Istart.hpp"
  #include "lipservice/BROADR/Card2/Istrap.hpp"
  #include "lipservice/BROADR/Card2/Temp1.hpp"
