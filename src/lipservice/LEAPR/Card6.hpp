class Card6 {
  public:
  #include "lipservice/LEAPR/Card6/Nss.hpp"
  #include "lipservice/LEAPR/Card6/B7.hpp"
  #include "lipservice/LEAPR/Card6/Aws.hpp"
  #include "lipservice/LEAPR/Card6/Sps.hpp"
  #include "lipservice/LEAPR/Card6/Mss.hpp"
