class Card5 {
  public:
  #include "lipservice/LEAPR/Card5/Awr.hpp"
  #include "lipservice/LEAPR/Card5/Spr.hpp"
  #include "lipservice/LEAPR/Card5/Npr.hpp"
  #include "lipservice/LEAPR/Card5/Iel.hpp"
  #include "lipservice/LEAPR/Card5/Ncold.hpp"
  #include "lipservice/LEAPR/Card5/Nsk.hpp"
