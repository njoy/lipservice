class Card8 {
public:
  #include "lipservice/PLOTR/Card8/Iverf.hpp"
  #include "lipservice/PLOTR/Card8/Nin.hpp"
  #include "lipservice/PLOTR/Card8/Matd.hpp"
  #include "lipservice/PLOTR/Card8/Mfd.hpp"
  #include "lipservice/PLOTR/Card8/Mtd.hpp"
  #include "lipservice/PLOTR/Card8/Temper.hpp"
  #include "lipservice/PLOTR/Card8/Nth.hpp"
  #include "lipservice/PLOTR/Card8/Ntp.hpp"
  #include "lipservice/PLOTR/Card8/Nkh.hpp"
  #include "lipservice/PLOTR/src/readNtpNkh.hpp"
