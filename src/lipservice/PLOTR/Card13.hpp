class Card13 {
public:
  #include "lipservice/PLOTR/Card13/Xdata.hpp"
  #include "lipservice/PLOTR/Card13/Ydata.hpp"
  #include "lipservice/PLOTR/Card13/Yerr1.hpp"
  #include "lipservice/PLOTR/Card13/Yerr2.hpp"
  #include "lipservice/PLOTR/Card13/Xerr1.hpp"
  #include "lipservice/PLOTR/Card13/Xerr2.hpp"
