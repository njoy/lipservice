class Card1 {
public:
  #include "lipservice/PLOTR/Card1/Lori.hpp"
  #include "lipservice/PLOTR/Card1/Istyle.hpp"
  #include "lipservice/PLOTR/Card1/Size.hpp"
  #include "lipservice/PLOTR/Card1/Ipcol.hpp"
