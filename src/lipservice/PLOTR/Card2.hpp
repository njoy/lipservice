class Card2 {
public:
  #include "lipservice/PLOTR/Card2/Iplot.hpp"
  #include "lipservice/PLOTR/Card2/Iwcol.hpp"
  #include "lipservice/PLOTR/Card2/Factx.hpp"
  #include "lipservice/PLOTR/Card2/Facty.hpp"
  #include "lipservice/PLOTR/Card2/Ll.hpp"
  #include "lipservice/PLOTR/Card2/Ww.hpp"
  #include "lipservice/PLOTR/Card2/Wh.hpp"
  #include "lipservice/PLOTR/Card2/Wr.hpp"
