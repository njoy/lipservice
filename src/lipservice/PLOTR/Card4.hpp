class Card4 {
public:
  #include "lipservice/PLOTR/Card4/Itype.hpp"
  #include "lipservice/PLOTR/Card4/Jtype.hpp"
  #include "lipservice/PLOTR/Card4/Igrid.hpp"
  #include "lipservice/PLOTR/Card4/Ileg.hpp"
  #include "lipservice/PLOTR/Card4/Xtag.hpp"
  #include "lipservice/PLOTR/Card4/Ytag.hpp"
