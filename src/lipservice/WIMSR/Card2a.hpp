...
public:
  ...
  #include "lipservice/WIMSR/Card2a/Ngnd.hpp"
  #include "lipservice/WIMSR/Card2a/Nfg.hpp"
  #include "lipservice/WIMSR/Card2a/Nrg.hpp"
  #include "lipservice/WIMSR/Card2a/Igref.hpp"
