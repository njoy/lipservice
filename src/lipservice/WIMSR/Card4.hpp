...
public:
  ...
  #include "lipservice/WIMSR/Card4/Ntemp.hpp"
  #include "lipservice/WIMSR/Card4/Nsigz.hpp"
  #include "lipservice/WIMSR/Card4/Sgref.hpp"
  #include "lipservice/WIMSR/Card4/Ires.hpp"
  #include "lipservice/WIMSR/Card4/Sigp.hpp"
  #include "lipservice/WIMSR/Card4/Mti.hpp"
  #include "lipservice/WIMSR/Card4/Mtc.hpp"
  #include "lipservice/WIMSR/Card4/Ip1opt.hpp"
  #include "lipservice/WIMSR/Card4/Inorf.hpp"
  #include "lipservice/WIMSR/Card4/Isof.hpp"
  #include "lipservice/WIMSR/Card4/Ifprod.hpp"
  #include "lipservice/WIMSR/Card4/Jp1.hpp"
