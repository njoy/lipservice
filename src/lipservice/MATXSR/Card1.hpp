...
public:
  ...
  #include "lipservice/MATXSR/Card1/Ngen1.hpp"
  #include "lipservice/MATXSR/Card1/Ngen2.hpp"
  #include "lipservice/MATXSR/Card1/Nmatx.hpp"
  #include "lipservice/MATXSR/Card1/Ngen3.hpp"
  #include "lipservice/MATXSR/Card1/Ngen4.hpp"
