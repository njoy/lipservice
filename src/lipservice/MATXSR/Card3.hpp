...
public:
  ...
  #include "lipservice/MATXSR/Card3/Npart.hpp"
  #include "lipservice/MATXSR/Card3/Ntype.hpp"
  #include "lipservice/MATXSR/Card3/Nholl.hpp"
  #include "lipservice/MATXSR/Card3/Nmat.hpp"
