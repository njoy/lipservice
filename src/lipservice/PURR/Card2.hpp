...
public:
  ...
  #include "lipservice/PURR/Card2/Ntemp.hpp"
  #include "lipservice/PURR/Card2/Nsigz.hpp"
  #include "lipservice/PURR/Card2/Nbin.hpp"
  #include "lipservice/PURR/Card2/Nladr.hpp"
  #include "lipservice/PURR/Card2/Iprint.hpp"
  #include "lipservice/PURR/Card2/Nunx.hpp"
