class Card2 {
public:
  #include "lipservice/ACER/Card2/Iopt.hpp"
  #include "lipservice/ACER/Card2/Iprint.hpp"
  #include "lipservice/ACER/Card2/Itype.hpp"
  #include "lipservice/ACER/Card2/Suff.hpp"
  #include "lipservice/ACER/Card2/Nxtra.hpp"
