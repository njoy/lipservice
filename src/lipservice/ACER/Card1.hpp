class Card1 {
public:
  #include "lipservice/ACER/Card1/Nendf.hpp"
  #include "lipservice/ACER/Card1/Npend.hpp"
  #include "lipservice/ACER/Card1/Ngend.hpp"
  #include "lipservice/ACER/Card1/Nace.hpp"
  #include "lipservice/ACER/Card1/Ndir.hpp"
