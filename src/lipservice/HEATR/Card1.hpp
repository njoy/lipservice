class Card1{
  public:
  #include "lipservice/HEATR/Card1/Nendf.hpp"
  #include "lipservice/HEATR/Card1/Nin.hpp"
  #include "lipservice/HEATR/Card1/Nout.hpp"
  #include "lipservice/HEATR/Card1/Nplot.hpp"
