class Card2 {
  ...
  #include "lipservice/HEATR/Card2/Npk.hpp"
  #include "lipservice/HEATR/Card2/Nqa.hpp"
  #include "lipservice/HEATR/Card2/Ntemp.hpp"
  #include "lipservice/HEATR/Card2/Local.hpp"
  #include "lipservice/HEATR/Card2/Iprint.hpp"
  #include "lipservice/HEATR/Card2/Ed.hpp"
