class Card8c {
public:
  #include "lipservice/GROUPR/Card8c/Eb.hpp"
  #include "lipservice/GROUPR/Card8c/Tb.hpp"
  #include "lipservice/GROUPR/Card8c/Ec.hpp"
  #include "lipservice/GROUPR/Card8c/Tc.hpp"
