class Card1 {
public:
  #include "lipservice/GROUPR/Card1/Nendf.hpp"
  #include "lipservice/GROUPR/Card1/Npend.hpp"
  #include "lipservice/GROUPR/Card1/Ngout1.hpp"
  #include "lipservice/GROUPR/Card1/Ngout2.hpp"
