class Card8a {
public:
  #include "lipservice/GROUPR/Card8a/Fehi.hpp"
  #include "lipservice/GROUPR/Card8a/Sigpot.hpp"
  #include "lipservice/GROUPR/Card8a/Nflmax.hpp"
  #include "lipservice/GROUPR/Card8a/Ninwt.hpp"
  #include "lipservice/GROUPR/Card8a/Jsigz.hpp"
  #include "lipservice/GROUPR/Card8a/Alpha2.hpp"
  #include "lipservice/GROUPR/Card8a/Sam.hpp"
  #include "lipservice/GROUPR/Card8a/Beta.hpp"
  #include "lipservice/GROUPR/Card8a/Alpha3.hpp"
  #include "lipservice/GROUPR/Card8a/Gamma.hpp"
