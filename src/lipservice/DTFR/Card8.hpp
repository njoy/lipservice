class Card8 {
public:
#include "lipservice/DTFR/Card8/Hisnam.hpp"
#include "lipservice/DTFR/Card8/Mat.hpp"
#include "lipservice/DTFR/Card8/Jsigz.hpp"
#include "lipservice/DTFR/Card8/Dtemp.hpp"
