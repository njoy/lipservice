...
public:
  ...
  #include "lipservice/RESXSR/Card2/Nmat.hpp"
  #include "lipservice/RESXSR/Card2/Maxt.hpp"
  #include "lipservice/RESXSR/Card2/Nholl.hpp"
  #include "lipservice/RESXSR/Card2/Efirst.hpp"
  #include "lipservice/RESXSR/Card2/Elast.hpp"
  #include "lipservice/RESXSR/Card2/Eps.hpp"
