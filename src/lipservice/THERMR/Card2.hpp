class Card2 {
public:
  #include "lipservice/THERMR/Card2/Matde.hpp"
  #include "lipservice/THERMR/Card2/Matdp.hpp"
  #include "lipservice/THERMR/Card2/Nbin.hpp"
  #include "lipservice/THERMR/Card2/Ntemp.hpp"
  #include "lipservice/THERMR/Card2/Iin.hpp"
  #include "lipservice/THERMR/Card2/Icoh.hpp"
  #include "lipservice/THERMR/Card2/Iform.hpp"
  #include "lipservice/THERMR/Card2/Natom.hpp"
  #include "lipservice/THERMR/Card2/Mtref.hpp"
  #include "lipservice/THERMR/Card2/Iprint.hpp"
